...
#include <ligero/gadgetlib1/gadgets/basic_gadgets.hpp>
#include <ligero/gadgetlib1/gadgets/hashes/hash_io.hpp>
#include <ligero/gadgetlib1/gadgets/hashes/sha256/sha256_aux.hpp>
...
template<typename FieldT>
class sha256_message_schedule_gadget : public gadget<FieldT> { // 扩展16个字到64个字
public:
    std::vector<pb_variable_array<FieldT> > W_bits; // pb_v_array套vector
...
#include <ligero/gadgetlib1/gadgets/hashes/sha256/sha256_components.tcc>
