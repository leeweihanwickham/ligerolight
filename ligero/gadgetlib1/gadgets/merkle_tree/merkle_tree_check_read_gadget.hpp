...
#include <ligero/gadgetlib1/gadgets/hashes/digest_selector_gadget.hpp>
#include <ligero/gadgetlib1/gadgets/hashes/hash_io.hpp>
#include <ligero/gadgetlib1/gadgets/merkle_tree/merkle_authentication_path_variable.hpp>
...
public:
    ...
    merkle_authentication_path_variable<FieldT, HashT> path;  //存储着一个用vec<bit_vec>生成的路径
...
#include <ligero/gadgetlib1/gadgets/merkle_tree/merkle_tree_check_read_gadget.tcc>
