 ...
 *             and contributors
 *             (see AUTHORS for libsnark and here for ligero).
 *****************************************************************************/

#ifndef ligero_RELATIONS_VARIABLE_HPP_
#define ligero_RELATIONS_VARIABLE_HPP_
...
#include <ligero/relations/variable.tcc>

#endif // ligero_RELATIONS_VARIABLE_HPP_
